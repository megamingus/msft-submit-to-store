...
namespace StoreSubmission
{
    ...
    /// </summary>
    public class AppSubmissionUpdate
    {
        ...
        public AppSubmissionUpdate(ClientConfiguration c)
        {
            this.ClientConfig = c;
        }

        public void RunAppSubmissionUpdate()
        {
            // **********************
            //       SETTINGS
            // **********************
            ...
            var file = this.ClientConfig.AppxFile;
            var zipFile = this.ClientConfig.ZipFile;
            var mandatory = this.ClientConfig.IsMandatory;
            var publishMode = Enum.GetName(typeof(TargetPublishMode), this.ClientConfig.PublishMode);
            ...
            clonedSubmission.targetPublishMode = publishMode;
            clonedSubmission.packageDeliveryOptions.isMandatoryUpdate = mandatory;
            clonedSubmission.packageDeliveryOptions.mandatoryUpdateEffectiveDate = "1601-01-01T00:00:00.0000000Z";
            ...
            IngestionClient.UploadFileToBlob(zipFile, fileUploadUrl).Wait();
            ...
            if ("CommitFailed".Equals(submissionStatus))
            {
                ...
                Console.WriteLine("###########################################################");
                Console.WriteLine(completeStatus);
                Console.WriteLine("###########################################################");
                return;
            }
            else
